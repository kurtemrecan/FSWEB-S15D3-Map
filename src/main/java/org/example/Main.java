...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "büsra", "kurt"));
        employees.add(new Employee(2, "emre", "kurt"));
        employees.add(new Employee(3, "kerem", "çetiner"));
        employees.add(new Employee(4, "ebru", "çetiner"));
        employees.add(new Employee(1, "büsra", "kurt"));
